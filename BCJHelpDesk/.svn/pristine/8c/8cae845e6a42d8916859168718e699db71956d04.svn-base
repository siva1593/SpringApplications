...
/**
 * Implements methods and maps the requests related to employee
 * tickets like creating, displaying. It also has some data populating methods.
 * 
 * @author Siva Reddy
 *
 */
...
public class EmployeeTicketsController {
	...
	/**
	 * Forwards list of tickets which are newly created by Student/Consultant.
	 * 
	...
	/**
	 * Forwards list of tickets which are approved.
	 * 
	...
	/**
	 * Forwards list of tickets which are denied.
	 * 
	 ...
	 * 
	 * @param model
	 *            Gets the ticket's data to be rejected.
	 * @param ticket
	 *            The model data is mapped with the ticket entity class.
	 * @param session
	 *            To get the user Id.
